...
from deltapy.security.null.manager import NullSecurityManager
from deltapy.application.decorators import register
from deltapy.security.null import APP_NULL_SECURITY

@register(APP_NULL_SECURITY)
class NullSecurityManagerComponent(NullSecurityManager):
    '''
    '''