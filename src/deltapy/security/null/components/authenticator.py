...
from deltapy.security.null.authenticator import NullAuthenticator
from deltapy.application.decorators import register
from deltapy.security.null import APP_NULL_AUTHENTICATOR

@register(APP_NULL_AUTHENTICATOR)
class NullAuthenticatorComponent(NullAuthenticator):
    '''
    '''
