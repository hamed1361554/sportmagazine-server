...
from deltapy.security.database.authenticator import Authenticator
from deltapy.security.database import APP_DATABASE_AUTHENTICATOR

@register(APP_DATABASE_AUTHENTICATOR)
